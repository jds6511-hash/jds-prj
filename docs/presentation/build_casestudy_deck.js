...
sceneSlide({
  ...
  title: "내가 고른 장면에서는 핵심 정보가 빠지고, 1위 장면에서는 편집 자막까지 읽혔다",
  frame: "seg0000_00000s.jpg",
  /* 감사(2026-08-26): 이 프레임은 영상 0:00 인트로 구간이라 채널 타이틀 로고가
   * 새우를 부분적으로 덮는다. 3B 오서술 해석에 이 요인을 병기한다. */
  desc: "프라이팬에 기름이 차 있고 가운데에 새우 한 점 — 인트로 로고가 새우를 일부 가린다",
  queries: [
  ...
  miss: {
    ...
    bandHead: "④ Q2에서 3B는 내가 고른 장면을 31위로 두고 seg188을 1위로 올렸다 — 같은 요리의 15분 뒤 시점이다",
    top1CardLabel: "1위가 된 장면 — 편집 자막까지 읽었다",
    top1Cap: "“…두 개의 새우가 보입니다. … 화면 하단에는 한글 자막이 있으며, ‘이대로 기름에 튀기듯 구워주면 끝!’…”",
    top1Hit: "“새우”는 장면에서 · “기름에 튀기”는 편집 자막에서",
  },
  read: "내가 고른 장면의 캡션에는 팬 · 기름 · 새우 · 튀기다가 없었고, 1위 장면의 캡션에는 영상 위에 덧씌운 편집 자막 문구까지 들어가 검색어와 직접 겹쳤다.\n두 요인이 함께 작용했을 가능성이 있다. 같은 질문에서 4B는 내가 고른 장면을 1위로 올렸다.",
});

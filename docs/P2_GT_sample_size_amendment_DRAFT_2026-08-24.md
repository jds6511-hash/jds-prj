# P2 GT 표본 규모 amendment — **DRAFT** (2026-08-24)

**확정 문서가 아니다.** 사용자 승인 전이며, 승인 없이 이 문서의 내용을 실행하지 않는다.
사전등록 본문(`부호역전_확증_사전등록_2026-08-18.md`)과 보충1~4는 **수정하지 않는다.**
이 문서는 이탈이 아니라 **표본 규모 하나에 대한 amendment 후보**다.
...
ICC가 크면 m 축소의 손해가 작아진다. 즉 **ICC=0 행이 손해의 상한**이다.

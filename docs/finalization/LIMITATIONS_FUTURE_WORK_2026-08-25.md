...
**11. 캡션 오염 검출기가 가장 흔한 혼입 유형을 놓친다 (자체 측정, 2026-08-25).**
`common.is_corrupted_caption`은 한자·가나를 **절대 3자 이상 또는 비율 20% 초과**로
판정한다. 그런데 실제 혼입 대부분이 **2자 삽입**이라 임계값 아래로 빠져나간다.

```
배포 인덱스   캡션 2,751건 · 현행 규칙 판정 4건(0.15%) · 한글·ASCII 외 글자 포함 227건(8.25%)
AI Hub       캡션 2,328건 · 현행 규칙 판정 0건        · 동일 기준 179건(7.69%)
미탐 227건의 구성   CJK/가나만 87.7% · 키릴 · 라틴(악센트) 소수
실제 예          "카모フラ주제 의상" · "훈련기가停박되어" · "금속 구조물이满了" · "잎っぱ라진"
```

**전면 차단 규칙은 답이 아니다.** 미탐 중 일부는 **간판에 적힌 외국어를 따옴표로 정확히

...
문서가 많다(루트 43 · `finalization/` 103 · `preregistration/` 39 · `probes/` 103 — 이 중 md 19, 나머지는 JSON 산출물).
**전부 읽을 필요 없다.** 아래 세 줄이 진입점이고 나머지는 필요할 때 찾는다.

| 상황 | 읽을 것 |
|---|---|
| 세션 재시작 | [작업현황_2026-09-03.md](작업현황_2026-09-03.md) — 가장 최신 스냅샷(§14까지) |
| 트랙·아키텍처 지도 | [PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md) — TRACK A/B/C 역할과 현재 gate |
...
| 파일 | 그 시점 |
|---|---|
| [작업현황_2026-09-03.md](작업현황_2026-09-03.md) | **최신** — §13·§14에 WVR TRACK C 체인 |
| [작업현황_2026-09-02.md](작업현황_2026-09-02.md) | v2.1 acceptance 집계 |
| [작업현황_2026-08-25.md](작업현황_2026-08-25.md) | 최종화 단계 진입 |

...
문서가 27개다. **전부 읽을 필요 없다.** 아래 세 줄이 진입점이고, 나머지는 필요할 때 찾는다.

| 상황 | 읽을 것 |
|---|---|
| 세션 재시작 | [작업현황_2026-08-14.md](작업현황_2026-08-14.md) — 확정 수치·다음 할 일·주의사항 |
| 8회차 판정 대기 중 | [판정자료_2026-08-17.md](판정자료_2026-08-17.md) |
...
| [작업현황_2026-08-14.md](작업현황_2026-08-14.md) | 최신 스냅샷. **재시작 진입점** |
| [판정자료_2026-08-17.md](판정자료_2026-08-17.md) | 8회차 개방 판정용 수치 모음 |
...
8월: 작업현황 08-04 / 08-07 / 08-09 / 08-10 / 08-12
